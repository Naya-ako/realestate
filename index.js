...
const frame2body = document.getElementById("frame2body")
const buttonNav = document.getElementById("buttonNav")
const buttons = buttonNav.querySelectorAll("button")
...
const properties = [
    {
        ...
        price: 1200,
        image: null, 
        imagesource: "./styles/images/unsplash_Eh_It1hg4Hs.png"
    },
    {
        address: "2578 Folsom street, san francisco, CA, 94110",
        roomType: "Private Room",
        price: 1200,
        image: null, 
        imagesource: "./styles/images/unsplash_2d4lAQAlbDA.png"
    },
    {
        address: "2578 Folsom street, san francisco, CA, 94110",
        roomType: "Private Room",
        price: 1200,
        image: null, 
        imagesource: "./styles/images/unsplash_T6d96Qrb5MY.png" 
    },
    {
        address: "2578 Folsom street, san francisco, CA, 94110",
        roomType: "Private Room",
        price: 1200,
        image: null, 
        imagesource: "./styles/images/unsplash_KQgrVfR3r74.png"
    },
    {
        address: "2578 Folsom street, san francisco, CA, 94110",
        roomType: "Private Room",
        price: 1200,
        image: null, 
        imagesource: "./styles/images/unsplash_UV81E0oXXWQ.png"
    },
    {
        address: "2578 Folsom street, san francisco, CA, 94110",
        roomType: "Private Room",
        price: 1200,
        image: null, 
        imagesource: "./styles/images/unsplash_uDtC-1NLEzU.png" 
    },
]
...
const pageDivider = () => {
  ...
  const elementsForPage = properties.slice(startIndex, endIndex);
    frame2body.innerHTML = ""


    elementsForPage.forEach(element => {
        const div1 = document.createElement("div")
        div1.setAttribute("class", "prop1")
  
        if (element.image) {
            const img = document.createElement("img");
            div1.appendChild(img)
            const url = URL.createObjectURL(element.image)
            img.src = url;
        }
        ...
        h2.innerText = element.address;
        
        const h4 = document.createElement("h4");
        h4.innerText = element.roomType;
        
        const h3 = document.createElement("h3");
        h3.innerText = `$${element.price}/month`;
        
        const div2 = document.createElement("div");
        div2.setAttribute("class", "descr")
...
function updateActiveButton() {
    ...
    const activeButton = buttonNav.querySelector(`button:nth-child(${currentPage + 1})`);
    if (activeButton) {
      ...
      buttons.forEach((button, index) => {
          ...
          } else if (currentPage >= Math.ceil(properties.length / itemsPerPage)) {
              if (index === 0) {
